...
class GuestHomeWidget extends StatefulWidget {
  ...
  static String routeName = 'GuestHome';
  static String routePath = '/guestHome';
                          ...
                          child: Padding(
                            ...
                            child: StreamBuilder<List<BusinessRow>>(
                              stream: FFAppState().priorityBusiness(
                                requestFn: () =>
                                    _model.listViewSupabaseStream ??= SupaFlow
                                        .client
                                        .from("business")
                                  ...
                                  if (_model.choiceChipsValue == 'All')
                                    Padding(
                                      ...
                                      child: FutureBuilder<List<BusinessRow>>(
                                        future: FFAppState().business(
                                          requestFn: () =>
                                              BusinessTable().queryRows(
                                            queryFn: (q) => q,
                                          ),
                                        ),
                                        builder: (context, snapshot) {
                                          ...
                                          List<BusinessRow>
                                              fullListViewBusinessRowList =
                                              snapshot.data!;

                                          if (fullListViewBusinessRowList
                                              .isEmpty) {
                                            return Image.asset(
                                              'assets/images/Black_And_White_Globe_Y2k_Streetwear_Logo-removebg-preview.png',
                                            );
                                          }
                                          ...
                                          return ListView.separated(
                                            ...
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 8.0),
                                            itemBuilder:
                                                (context, fullListViewIndex) {
                                              final fullListViewBusinessRow =
                                                  fullListViewBusinessRowList[
                                                      fullListViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                    ...
                                    Padding(
                                      ...
                                      child: FutureBuilder<List<BusinessRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<BusinessRow>
                                              filteredListViewBusinessRowList =
                                              snapshot.data!;

                                          if (filteredListViewBusinessRowList
                                              .isEmpty) {
                                            return Image.asset(
                                              'assets/images/Black_And_White_Globe_Y2k_Streetwear_Logo-removebg-preview.png',
                                            );
                                          ...
                                          return ListView.separated(
                                            ...
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 8.0),
                                            itemBuilder: (context,
                                                filteredListViewIndex) {
                                              final filteredListViewBusinessRow =
                                                  filteredListViewBusinessRowList[
                                                      filteredListViewIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                              ...
                                                              children: [
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    if (filteredListViewBusinessRow
                                                                            .vacancies ==
                                                                        true)
                                                                      Expanded(
                                                                        child:

          ...
          body: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: Image.asset(
                  'assets/images/New_Christian_Economy_-_Sign_Up_(Dark).png',
                ).image,
              ),
            ),
            child: Column(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Autocomplete<String>(
                                        ...
                                        optionsBuilder: (textEditingValue) {
                                          ...
                                          return locationLocationRowList
                                              .map((e) => e.city)
                                              .withoutNulls
                                              .toList()
                                              .where((option) {
                                    ...
                                    child: Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          future: AuthGroup.signupCall.call(),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                            ...
                                            final buttonLoginSignupResponse =
                                                snapshot.data!;
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (_model.switchValue!) {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'You must affirm the Nicene Creed to create an account',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,

                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fadeOutDuration:
                                            Duration(milliseconds: 500),
                                        imageUrl: _model.uploadedFileUrl_uploadDataCoverEdit2 !=
                                                    ''
                                            ? _model
                                                .uploadedFileUrl_uploadDataCoverEdit2
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_uploadDataCoverEdit2 =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataCoverEdit2 =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataCoverEdit2 =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataCoverEdit2 =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                                          ...
                                          child: InkWell(
                                              ...
                                              if (selectedMedia != null &&
                                                  selectedMedia.every((m) =>
                                                      validateFileFormat(
                                                          ...
                                                          context))) {
                                                safeSetState(() => _model
                                                        .isDataUploading_uploadDataBusinessEdit2 =
                                                    true);
                                                var selectedUploadedFiles =
                                                    <FFUploadedFile>[];
                                                ...
                                                try {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                      .hideCurrentSnackBar();
                                                  _model.isDataUploading_uploadDataBusinessEdit2 =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                            .length ==
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedMedia.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadDataBusinessEdit2 =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadDataBusinessEdit2 =
                                                        downloadUrls.first;
                                                  });
                                                  showUploadMessage(
                                                      context, 'Success!');
                                            ...
                                            child: Container(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                fadeOutDuration:
                                                    Duration(milliseconds: 500),
                                                imageUrl: _model.uploadedFileUrl_uploadDataBusinessEdit2 !=
                                                            ''
                                                    ? _model
                                                        .uploadedFileUrl_uploadDataBusinessEdit2
                                                    : columnUsersRow!
                                                        .profilePhoto!,
                                                fit: BoxFit.fitWidth,
                                              ),
                        ...
                        data: {
                          ...
                          'profile_photo':
                              _model.uploadedFileUrl_uploadDataBusinessEdit2 !=
                                  ...
                                  ? _model
                                      .uploadedFileUrl_uploadDataBusinessEdit2
                                  : columnUsersRow?.profilePhoto,
                          'cover_photo': _model.uploadedFileUrl_uploadDataCoverEdit2 !=
                                      ''
                              ? _model.uploadedFileUrl_uploadDataCoverEdit2
                              : columnUsersRow?.coverPhoto,
                        },

...
class _EditJobWidgetState extends State<EditJobWidget> {
  ...
  void initState() {
    ...
    _model.positionNameFocusNode ??= FocusNode();

    _model.locationFocusNode ??= FocusNode();

    _model.applicationLinkFocusNode ??= FocusNode();

    _model.justificationFocusNode ??= FocusNode();
                            ...
                            Align(
                              ...
                              child: FutureBuilder<List<JobsRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<JobsRow> maxWidthJobsRowList =
                                      snapshot.data!;

                                  final maxWidthJobsRow =
                                      maxWidthJobsRowList.isNotEmpty
                                          ? maxWidthJobsRowList.first
                                          : null;
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                TextFormField(
                                                  controller: _model
                                                          .positionNameTextController ??=
                                                      TextEditingController(
                                                    text: maxWidthJobsRow
                                                        ?.jobName,
                                                  ),
                                                  focusNode: _model
                                                      .positionNameFocusNode,
                                                  autofocus: true,
                                                  textCapitalization:
                                                      TextCapitalization
                                                          .sentences,
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primary,
                                                  validator: _model
                                                      .positionNameTextControllerValidator
                                                      .asValidator(context),
                                                  inputFormatters: [
                                                    if (!isAndroid && !isiOS)
                                                      TextInputFormatter
                                                ...
                                                TextFormField(
                                                  controller: _model
                                                          .applicationLinkTextController ??=
                                                      TextEditingController(
                                                    text: maxWidthJobsRow
                                                        ?.applicationLink,
                                                  ),
                                                  focusNode: _model
                                                      .applicationLinkFocusNode,
                                                  autofocus: true,
                                                  textCapitalization:
                                                      TextCapitalization.words,
                                                  obscureText: false,
                                                ...
                                                TextFormField(
                                                  controller: _model
                                                          .justificationTextController ??=
                                                      TextEditingController(
                                                    text: maxWidthJobsRow
                                                        ?.details,
                                                  ),
                                                  focusNode: _model
                                                      .justificationFocusNode,
                                                  autofocus: true,
                                                  textCapitalization:
                                                      TextCapitalization.words,
                                                  obscureText: false,
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primary,
                                                  validator: _model
                                                      .justificationTextControllerValidator
                                                      .asValidator(context),
                                                  inputFormatters: [
                                                    if (!isAndroid && !isiOS)
                                                      TextInputFormatter
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await JobsTable().update(
                                data: {
                                  'job_name':
                                      _model.positionNameTextController.text,
                                  'details':
                                      _model.justificationTextController.text,
                                  'location':
                                      _model.locationTextController.text,
                                  'application_link':
                                      _model.applicationLinkTextController.text,
                                },

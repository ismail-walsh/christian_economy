                    ...
                    children: [
                      StreamBuilder<List<JobsRow>>(
                        stream: _model.listViewSupabaseStream ??= SupaFlow
                            ...
                            .map((list) =>
                                list.map((item) => JobsRow(item)).toList()),
                        builder: (context, snapshot) {
                          ...
                          if (listViewJobsRowList.isEmpty) {
                            return Center(
                              child: Image.asset(
                                    ...
                                    child: Container(
                                      ...
                                      child: FutureBuilder<List<BusinessRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<BusinessRow>
                                              columnBusinessRowList =
                                              snapshot.data!;

                                          final columnBusinessRow =
                                              columnBusinessRowList.isNotEmpty
                                                                      ...
                                                                      var confirmDialogResponse = await showDialog<
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return AlertDialog(
                                                                                ...
                                                                                content: Text('Are you sure you would like to delete this job?'),
                                                                                actions: [
                                                                                  TextButton(
                                                                                    onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                    child: Text('Cancel'),
                                                                      ...
                                                                      if (confirmDialogResponse) {
                                                                        ...
                                                                        ScaffoldMessenger.of(context)
                                                                          ...
                                                                          SnackBar(
                                                                            content:
                                                                                Text(
                                                                              'Job deleted. Refresh to see results',
                                                                              style: TextStyle(
                                                                                color: FlutterFlowTheme.of(context).primaryText,
                                                                              ),
                                                                            ),

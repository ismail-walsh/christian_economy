...
class _CreateBusinessWidgetState extends State<CreateBusinessWidget> {
  ...
  void initState() {
    ...
    _model.businessContactTextController ??= TextEditingController();
    _model.businessContactFocusNode ??= FocusNode();

    _model.descriptionTextController ??= TextEditingController();
    _model.descriptionFocusNode ??= FocusNode();

    _model.socialMediaLinksTextController1 ??= TextEditingController();
    _model.socialMediaLinksFocusNode1 ??= FocusNode();

    _model.socialMediaLinksTextController2 ??= TextEditingController();
    _model.socialMediaLinksFocusNode2 ??= FocusNode();

    _model.socialMediaLinksTextController3 ??= TextEditingController();
    _model.socialMediaLinksFocusNode3 ??= FocusNode();

    _model.socialMediaLinksTextController4 ??= TextEditingController();
    _model.socialMediaLinksFocusNode4 ??= FocusNode();

    _model.socialMediaLinksTextController5 ??= TextEditingController();
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    ...
                                                    fadeOutDuration: Duration(
                                                        milliseconds: 500),
                                                    imageUrl: _model.uploadedFileUrl_uploadDataCover !=
                                                                ''
                                                        ? _model
                                                        ...
                                                        child:
                                                          ...
                                                          fadeOutDuration:
                                                              Duration(
                                                                  milliseconds:
                                                                      500),
                                                          imageUrl: _model.uploadedFileUrl_uploadDataBusiness1 !=
                                                                      ''
                                                              ? _model
                                                                  .uploadedFileUrl_uploadDataBusiness1
                                                              : 'https://vtkehsyrggxuijxzymga.supabase.co/storage/v1/object/public/user_images/default-avatar-icon-of-social-media-user-vector.jpg?t=2025-01-12T19%3A23%3A25.180Z',
                                                          fit: BoxFit.fitWidth,
                                                        ),
                                                      ),
                                                    ),
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataBusiness1 =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataBusiness1 =
                                                                  selectedUploadedFiles
                                                                      .first;
                            ...
                            TextFormField(
                              controller: _model.businessContactTextController,
                              focusNode: _model.businessContactFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                            ...
                            Material(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  value: _model.vacanciesValue ??= true,
                                  onChanged: (newValue) async {
                                    safeSetState(() =>
                                        _model.vacanciesValue = newValue!);
                                  },
                                  title: Text(
                                    'Vacancies',
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Material(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  value: _model.sundaysValue ??= true,
                                  onChanged: (newValue) async {
                                    safeSetState(
                                        () => _model.sundaysValue = newValue!);
                                  },
                                  title: Text(
                                    'Sundays',
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Material(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  value: _model.charityValue ??= true,
                                  onChanged: (newValue) async {
                                    safeSetState(
                                        () => _model.charityValue = newValue!);
                                  },
                                  title: Text(
                                    'Charity',
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Material(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  value: _model.lifeValue ??= true,
                                  onChanged: (newValue) async {
                                    safeSetState(
                                        () => _model.lifeValue = newValue!);
                                  },
                                  title: Text(
                                    'Pro-life',
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Material(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  value: _model.churchValue ??= true,
                                  onChanged: (newValue) async {
                                    safeSetState(
                                        () => _model.churchValue = newValue!);
                                  },
                                  title: Text(
                                    'Church',
                                    style: FlutterFlowTheme.of(context)

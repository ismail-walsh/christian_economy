                              ...
                              child: Column(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/pexels-elti-meshau-333850.jpg',
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'See the list of companies that have been blacklisted, and vote on ongoing ballots.',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelSmall
                                                    .override(
                  ...
                  StickyHeader(
                    ...
                    content:
                      ...
                      child: FutureBuilder<List<BlacklistRow>>(
                        future: FFAppState().getBlacklistItems(
                          requestFn: () => BlacklistTable().queryRows(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return InkWell(
                            ...
                            onTap: () async {
                              if (_model.choiceChipsValue == 'rejected') {
                                FFAppState().clearGetBlacklistItemsCache();
                                                              ...
                                                              children: [
                                                                            ...
                                                                            Align(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  dateTimeFormat(
                                                                                    "d/M/y",
                                                                                    listViewBlacklistRow.expirationDate!,
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    percent: (DateTime.now().difference(DateTime.parse(listViewBlacklistRow.createdAt.toString())).inMilliseconds /
                                                                            DateTime.parse(listViewBlacklistRow.expirationDate!.toString())
                                                                                .difference(DateTime.parse(listViewBlacklistRow.createdAt
                                                                                    .toString()))
                                                                                .inMilliseconds)
                                                                        .clamp(
                                                                            0.0,
